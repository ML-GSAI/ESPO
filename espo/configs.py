# Adapted based on huggingface/open-r1: https://github.com/huggingface/open-r1/blob/6a0cd5c8ad031fc75118a4ce7f42a4860c3d8dea/src/open_r1/configs.py
...
class GRPOConfig(trl.GRPOConfig):
    ...
    num_mc: Optional[int] = field(
        default=1,
        metadata={"help": "Number of Monte Carlo samples to use for ELBO estimation."},
    )

    reduce_var: bool = field(
        default=True,
        metadata={"help": "Whether to use coupling trick for variance reduction in ELBO estimation."},
    )
